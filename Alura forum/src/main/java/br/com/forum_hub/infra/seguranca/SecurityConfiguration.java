    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers(HttpMethod.PATCH, "/topicos/{idTopico}/respostas/**").hasAnyRole("INSTRUTOR","ESTUDANTE");
                    ...
                    auth.requestMatchers(HttpMethod.PATCH, "/reativar-conta/**").hasRole("ADMIN");
                    auth.requestMatchers(HttpMethod.PATCH, "/desativar/**").hasRole("ADMIN");
